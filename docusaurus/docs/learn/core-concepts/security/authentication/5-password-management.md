...
Passwords may be reset via the [Edge Management API](/docs/reference/api#edge-management-api) by an administrative client.
...
Passwords may be reset via the [Edge Management API](/docs/reference/api#edge-management-api) or 
[Edge Client API](/docs/reference/api#edge-client-api) by the currently authenticated client.

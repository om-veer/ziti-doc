...
At this point you should have a functioning [Ziti Network](../overview#overview-of-a-ziti-network). The script 
...
Congratulations! You can now use the `ziti` CLI to interact with Ziti! ([Ziti CLI Help Here](/ziti/cli/cli)) The 

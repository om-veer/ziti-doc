...
[tunneling apps](/clients/which-client.md#tunnelers).
...
[Ziti Network](/overview.md#overview-of-a-ziti-network). For someone just starting out, there are four basic options:
...
access to your [Ziti Network](/overview.md#overview-of-a-ziti-network) and aren't on the local network.
* If you would prefer not to deal with setting up the [Ziti Network](/overview.md#overview-of-a-ziti-network) you
...
* [Run Everything Locally - no Docker](/quickstarts/network/local-no-docker.md)
* [Run Everything Locally - using Docker](/quickstarts/network/local-with-docker.md)
* [Run Everything Locally - Docker Compose](/quickstarts/network/local-docker-compose.md)
* [Run Everything Hosted](quickstarts/network/hosted.md)
